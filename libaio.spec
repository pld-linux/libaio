...
Summary(pl):	Biblioteka natywnego dla Linuksa asynchronicznego dostêpu do wej¶cia/wyj¶cia
Name:		libaio
Version:	0.3.104
Release:	1
License:	LGPL v2+
...
- udostêpnia natywne Linuksowe API dla asynchronicznego we/wy. Zgodne
z POSIX asynchroniczne we/wy wymaga tej biblioteki do udostêpnienia
...
Summary(pl):	Pliki nag³ówkowe biblioteki libaio
...
Pliki nag³ówkowe biblioteki libaio.
